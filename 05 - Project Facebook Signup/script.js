...
function changeImage(width) {
  if (width < 850) {
    const img = document.getElementsByClassName('facebook-logo')[0];
    img.src = 'https://static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg' 
  }
}

function changeInput(width) {
  const input1 = document.getElementById('user-email-phone');
  const input2 = document.getElementById('user-password');
  if (width < 850) {
    input1.placeholder = 'Numero de celular ou email';
